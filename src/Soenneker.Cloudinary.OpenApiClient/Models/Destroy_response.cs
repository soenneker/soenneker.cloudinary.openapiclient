...
namespace Soenneker.Cloudinary.OpenApiClient.Models
{
    ...
    public partial class Destroy_response : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public static global::Soenneker.Cloudinary.OpenApiClient.Models.Destroy_response CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Cloudinary.OpenApiClient.Models.Destroy_response();
        }
        /// <summary>
