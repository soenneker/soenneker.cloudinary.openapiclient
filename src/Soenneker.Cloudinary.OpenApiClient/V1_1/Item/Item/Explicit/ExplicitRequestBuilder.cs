...
{
    /// <summary>
    /// Builds and executes requests for operations under \v1_1\{cloudName}\{resourceType}\explicit
    /// </summary>
    ...
    public partial class ExplicitRequestBuilder : BaseRequestBuilder
    {
        ...
        public ExplicitRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1_1/{cloudName}/{resourceType}/explicit", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Cloudinary.OpenApiClient.V1_1.Item.Item.Explicit.ExplicitRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExplicitRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1_1/{cloudName}/{resourceType}/explicit", rawUrl)
        {
        }
        /// <summary>
